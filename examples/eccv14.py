...
from tinynet.layers import Softmax, Conv2D, Deconv2D, MaxPool2D, MaxUnpool2D
from tinynet.models.inv_vgg11 import inverse_vgg, load_weight, forward
...
def vis_layer(layer, feature_maps, inv_vgg, pool_locs):
    ...
    choose_map = np.where(choose_map == max_activation, choose_map, np.zeros(choose_map.shape))
