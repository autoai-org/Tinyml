...
def vgg16():
    ...
    model.add(
        Conv2D('b_1_conv2d_2', (16, 224, 224),
               n_filter=16,
               w_filter=3,
               h_filter=3,
               stride=1,
    ...
    model.add(
        MaxPool2D('b_1_pool_1', (16, 224, 224), (2, 2),
                  stride=2,
                  return_index=True))

    # Conv Block 2
    model.add(
        Conv2D('b_2_conv2d_1', (16, 112, 112),
               n_filter=32,
               w_filter=3,
               h_filter=3,
               stride=1,
    ...
    model.add(
        MaxPool2D('b_2_pool_1', (32, 112, 112), (2, 2), 2, return_index=True))
    ...
    model.add(
        MaxPool2D('b_3_pool_1', (64, 56, 56), (2, 2), 2, return_index=True))
    ...
    model.add(
        MaxPool2D('b_4_pool_1', (128, 28, 28), (2, 2), 2, return_index=True))
    ...
    model.add(
        MaxPool2D('b_5_pool_1', (256, 14, 14), (2, 2), 2, return_index=True))
