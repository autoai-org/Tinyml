...
def tinyvgg16():
    ...
    model.add(
        MaxPool2D('b_1_pool_1', (64, 64, 64), (2, 2),
                  stride=2,
                  return_index=True))

    # Conv Block 2
    model.add(
        Conv2D('b_2_conv2d_1', (64, 32, 32),
               n_filter=128,
               w_filter=3,
               h_filter=3,
               stride=1,
    ...
    model.add(
        MaxPool2D('b_2_pool_1', (128, 32, 32), (2, 2), 2, return_index=True))
    ...
    model.add(
        MaxPool2D('b_3_pool_1', (256, 16, 16), (2, 2), 2, return_index=True))
