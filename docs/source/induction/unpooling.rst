...
:math:`X=\left[ {\begin{array}{*{20}c} 
    1 & 2 & 3 \\
    4 & 5 & 6   \\
    7 & 8 & 9   
\end{array} } \right]` and the corresponding output
:math:`P=\left[ {\begin{array}{*{20}c}
    5 & 6    \\
    8 & 9
\end{array} } \right]`. Besides these, we will know the indices of the
...
output as :math:`\left[ {\begin{array}{*{20}c} 
    0 & 0 & 0 \\
    0 & 5 & 6   \\
    0 & 8 & 9   
\end{array} } \right]`
